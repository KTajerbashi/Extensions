...
using SoftwarepartDetector.Authentications;
using SoftwarepartDetector.Detectors;
using SoftwarepartDetector.Options;
using SoftwarepartDetector.Publishers;
using SoftwarepartDetector.Services;

namespace SoftwarepartDetector.Extensions.DependencyInjection;
